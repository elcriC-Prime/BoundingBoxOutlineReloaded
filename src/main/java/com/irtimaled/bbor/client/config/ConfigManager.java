...
//    public static Setting<HexColor> colorRuinedPortals;
    ...
    public static void loadConfig() {
        ...
        drawBiomeBorders = setup(config, "biomeBorders", "drawBiomeBorders", false, "If set to true biome borders will be drawn.");
...
//        biomeBordersMaxY = setup(config, "biomeBorders", "biomeBordersMaxY", -1, "The maximum top of the biome borders. If set to -1 it will use the value when activated, if set to 0 it will always track the players feet.");
        ...
        drawFlowerForests = setup(config, "flowerForests", "drawFlowerForests", false, "If set to true flower forest flower overlays will be drawn.");
        ...
        drawBedrockCeilingBlocks = setup(config, "bedrockCeiling", "drawBedrockCeilingBlocks", false, "If set to true position with only one layer of bedrock will be drawn.");
