...
public class ClientInterop {
    ...
    public static void render(MatrixStack matrixStack, Matrix4f modelViewMatrix, Matrix4f projectionMatrix, Camera camera, ClientPlayerEntity player) {
        ClientRenderer.render(matrixStack, modelViewMatrix, projectionMatrix, camera, DimensionId.from(player.getEntityWorld().getRegistryKey()));
    }
